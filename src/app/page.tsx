    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-6">
            ...
            {!user && (
              <section className="text-center space-y-3">
                ...
                <div className="flex flex-col sm:flex-row gap-2 justify-center">
                  ...
                  <Link
                    href="/register"
                    className="rounded-md border border-black px-4 py-1.5 text-sm font-bold text-slate-900 hover:bg-slate-50 transition-colors"
                  >
                    Register
                  </Link>
                </div>
        ...
        <section className="mt-4">
          <div className="bg-white rounded-xl shadow-md p-4 border border-slate-200 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center text-blue-600">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
              </div>
              <div>
                <h3 className="text-base font-bold text-slate-900">Connect with Friends</h3>
                <p className="text-xs text-slate-500">Find classmates and follow their academic journey.</p>
              </div>
            </div>
            <Link
              href="/login"
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          ...
          <Link
            ...
            className="group bg-white rounded-xl shadow-md p-4 hover:shadow-lg transition-all duration-200 border border-slate-200 hover:border-blue-500"
          >
          ...
          <Link
            ...
            className="group bg-white rounded-xl shadow-md p-4 hover:shadow-lg transition-all duration-200 border border-slate-200 hover:border-emerald-500"
          >
            <div className="flex items-start gap-3">
          ...
          <Link
            ...
            className="group bg-white rounded-xl shadow-md p-4 hover:shadow-lg transition-all duration-200 border border-slate-200 hover:border-purple-500"
          >
            <div className="flex items-start gap-3">
          ...
          <Link
            ...
            className="group bg-white rounded-xl shadow-md p-4 hover:shadow-lg transition-all duration-200 border border-slate-200 hover:border-slate-500"
          >
            <div className="flex items-start gap-3">
